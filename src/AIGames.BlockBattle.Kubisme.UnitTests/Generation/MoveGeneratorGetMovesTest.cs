	...
	public class MoveGeneratorGetMovesTest
	{
		...
		public void GetMoves_T_34candidates()
		{
			var exp = new string[]
			{
				...
				"left,left,left,turnleft,turnleft,drop",
				"left,left,turnleft,turnleft,drop",
				"left,turnleft,turnleft,drop",
				"turnleft,turnleft,drop",
				"right,turnright,turnright,drop",
				"right,right,turnright,turnright,drop",
				"right,right,right,turnright,turnright,drop",
				"right,right,right,right,turnright,turnright,drop",
